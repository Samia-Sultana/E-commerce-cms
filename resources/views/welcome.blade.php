            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="banner banner-border">
                        <a href="exclusive_product.html">
                            <img src="assets/img/product/panjabi/p1.jpg" class="img-responsive" alt="">
                        </a>
                ...
                <div class="col-md-4">
                    <div class="banner banner-border-hover">
                        <a href="#">
                            <img src="assets/img/product/panjabi/3x2/P1(3x2).jpg" class="img-responsive" alt="">
                        </a>
                        <div class="banner-content">
                            <div class="banner-title">
                                <h3>Exclusive collection</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-6 p-x-5">
                                ...
                                <div class="single-product-item text-center mb-3">
                                    <figure class="product-thumb">
                                        <a href="product_details.html"><img src="assets/img/product/panjabi/p1.jpg"
                                                alt="Products" class="img-fluid"></a>
                                    </figure>

                                    <div class="product-details">
                                        <h2><a href="product_details.html">Crown Summit Backpack</a></h2>
                                        <div class="product-code">
                                            <span class="code-title">Product Code: </span>
                                            <span class="code-no">S-3254</span>
                                        </div>
                                        <div class="price-div">
                                            <span class="price">BDT 2500</span>
                                            <span class="discount-price line-through">BDT 1500</span>
                                        </div>

                                        <button type="button" class="btn-add-to-cart">+ Add to
                                            Cart</button>
                                    </div>
